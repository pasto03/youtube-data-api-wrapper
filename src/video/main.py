...
class VideoResponse(BaseResponse):
    ...
    def _extract_snippet(self, raw_snippet: dict) -> VideoItemSnippet:
        ...
        snippet.categoryId = raw_snippet.get('categoryId')
        snippet.defaultAudioLanguage = raw_snippet['defaultAudioLanguage']
    ...
    def _extract_statistics(self, raw_statistics) -> VideoItemStatistics:
        ...
        statistics.viewCount = int(raw_statistics['viewCount'])
        statistics.likeCount = int(raw_statistics['likeCount'])
        statistics.favouriteCount = int(raw_statistics['favoriteCount'])
        statistics.commentCount = int(raw_statistics['commentCount'])
