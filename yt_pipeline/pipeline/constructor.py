...
class PipelineConstructor:
    def __init__(self): 
        ...
        """
        self.foreman_map: dict[str, UniqueForeman | IterableForeman | BaseForeman] = {
    ...
    def _construct_foreman(self, foreman_json: dict) -> IterableForeman | UniqueForeman | BaseForeman:
        foreman_name = foreman_json["name"]
        if foreman_name not in self.foreman_map.keys():
