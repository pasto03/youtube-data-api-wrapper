from yt_pipeline.retriever.base import UniqueRetriever, IterableRetriever
from yt_pipeline.regulator.estimator import UniqueEstimator, IterableEstimator, SearchEstimator
...
class UniqueRegulator:
    ...
    def _estimate_cost(self) -> int:
        ...
        cost = self.estimator.estimate(n_items // self.retriever.chunk_size)
        return cost
