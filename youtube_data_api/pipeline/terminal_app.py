...
from youtube_data_api.retriever.base.settings import RetrieveMethod
...
blockKeys: TypeAlias = Literal["videos", "channels", "search", "playlists", "playlist_items", "comments"]
